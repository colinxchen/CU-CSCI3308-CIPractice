...
START_TEST(test_2d_area)
{
    ...
    coord_2d_t c;
    double test_var;
    double answer1 = 200.0;
    double answer2 = 125.0;

    a.x = b.x = c.y = 0;
    a.y = 0;
    b.y = c.x = 20;
    test_var = coord_2d_area_triangle(&a, &b, &c);
    ck_assert(test_var == answer1);
...
Suite* coord_2d_suite(void)
{
    ...
    TCase* tc_2d_area = tcase_create("coord_2d_rea");
